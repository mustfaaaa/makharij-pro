          ...
          builder: (context, state) {
            ...
            return ListView(
              ...
              children: [
                ...
                // ── Quick stats (FutureBuilder — kept intact) ─────────
                    ...
                    return Row(children: [
                      ...
                      Expanded(
                        child: _StatCard(
                          ...
                          iconColor: AppColors.primary,
                          value:
                              '${(user?.overallAccuracy ?? 0).toStringAsFixed(0)}%',
                          label: 'Avg Score',
                          trend: '+4%',
                        ),
                      ),
                ...
                // ── Accuracy Trend chart (fl_chart — kept, gold color) ─
                SectionHeader(
                ...
                FutureBuilder<List<ProgressPoint>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (points.isEmpty) {
                      return const ShimmerBox(height: 200);
                    }
                    return Container(
                      height: 200,
                      padding:
                          const EdgeInsets.fromLTRB(8, 20, 16, 8),
                      decoration: AppTheme.cardDecoration(),
                      child: LineChart(
                        LineChartData(
                ...
                ...sessions.map(
                  (s) => Padding(
                    ...
                    child: RecentSessionCard(
                      session: s,
                      onTap: () => context.push(
                          RoutePaths.detailedFeedbackPath(s.id)),
                    ),
                  ),
                ),
              ],

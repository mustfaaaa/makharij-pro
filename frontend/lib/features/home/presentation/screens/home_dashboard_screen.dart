...
const _ayahs = [
  _AyahData('فَإِنَّ مَعَ الْعُسْرِ يُسْرًا',
      'For indeed, with hardship will be ease.', 'Al-Inshirah 94:5'),
  _AyahData('وَمَن يَتَوَكَّلْ عَلَى اللَّهِ فَهُوَ حَسْبُهُ',
      'And whoever relies upon Allah — then He is sufficient for him.', 'At-Talaq 65:3'),
  _AyahData('إِنَّ اللَّهَ مَعَ الصَّابِرِينَ',
      'Indeed, Allah is with the patient.', 'Al-Baqarah 2:153'),
  _AyahData('حَسْبُنَا اللَّهُ وَنِعْمَ الْوَكِيلُ',
      'Sufficient for us is Allah, and He is the best disposer of affairs.', 'Al-Imran 3:173'),
  _AyahData('رَبَّنَا آتِنَا فِي الدُّنْيَا حَسَنَةً وَفِي الْآخِرَةِ حَسَنَةً',
      'Our Lord, give us good in this world and good in the Hereafter.', 'Al-Baqarah 2:201'),
  _AyahData('وَبَشِّرِ الصَّابِرِينَ', 'And give good tidings to the patient.', 'Al-Baqarah 2:155'),
  _AyahData('إِنَّمَا يُوَفَّى الصَّابِرُونَ أَجْرَهُم بِغَيْرِ حِسَابٍ',
          ...
          Container(
            ...
            child: Row(
              ...
              children: List.generate(7, (i) {
                ...
                else if (isDone)  { bg = AppColors.successLight;  fg = AppColors.success; }
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text('Explore all 114 Surahs →',
                          style: TextStyle(
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('${surah.nameEnglish}  |  ${surah.ayahCount} Ayat',
                        style: const TextStyle(
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: _quickSurahs.map((s) => _SurahChip(
                        name: s.name,
                        onTap: () =>
            ...
            child: Row(children: [
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('Invite to MakharijPro',
                        style: TextStyle(
                            fontWeight: FontWeight.w800,
                            fontSize: 16,
                            color: AppColors.textPrimary)),
